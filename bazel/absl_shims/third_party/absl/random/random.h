...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_RANDOM_RANDOM_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_RANDOM_RANDOM_H_

#include "absl/random/random.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_RANDOM_RANDOM_H_
