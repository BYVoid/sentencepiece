...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_FUNCTIONAL_ANY_INVOCABLE_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_FUNCTIONAL_ANY_INVOCABLE_H_

#include "absl/functional/any_invocable.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_FUNCTIONAL_ANY_INVOCABLE_H_
