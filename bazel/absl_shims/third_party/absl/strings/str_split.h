...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_SPLIT_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_SPLIT_H_

#include "absl/strings/str_split.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_SPLIT_H_
