...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_JOIN_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_JOIN_H_

#include "absl/strings/str_join.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_JOIN_H_
