...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_CAT_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_CAT_H_

#include "absl/strings/str_cat.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_CAT_H_
