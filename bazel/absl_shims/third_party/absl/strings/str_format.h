...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_FORMAT_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_FORMAT_H_

#include "absl/strings/str_format.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_FORMAT_H_
