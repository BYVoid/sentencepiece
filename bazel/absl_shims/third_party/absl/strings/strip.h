...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STRIP_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STRIP_H_

#include "absl/strings/strip.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STRIP_H_
