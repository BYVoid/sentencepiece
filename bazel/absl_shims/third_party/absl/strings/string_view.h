...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STRING_VIEW_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STRING_VIEW_H_

#include "absl/strings/string_view.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STRING_VIEW_H_
