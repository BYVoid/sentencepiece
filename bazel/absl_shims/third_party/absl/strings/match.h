...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_MATCH_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_MATCH_H_

#include "absl/strings/match.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_MATCH_H_
