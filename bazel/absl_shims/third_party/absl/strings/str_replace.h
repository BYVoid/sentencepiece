...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_REPLACE_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_REPLACE_H_

#include "absl/strings/str_replace.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_STR_REPLACE_H_
