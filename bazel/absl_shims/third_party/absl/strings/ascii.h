...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_ASCII_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_ASCII_H_

#include "absl/strings/ascii.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_STRINGS_ASCII_H_
