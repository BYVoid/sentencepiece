...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_CLEANUP_CLEANUP_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_CLEANUP_CLEANUP_H_

#include "absl/cleanup/cleanup.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_CLEANUP_CLEANUP_H_
