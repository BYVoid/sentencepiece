...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_BASE_ATTRIBUTES_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_BASE_ATTRIBUTES_H_

#include "absl/base/attributes.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_BASE_ATTRIBUTES_H_
