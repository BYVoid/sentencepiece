...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_BASE_INTERNAL_ENDIAN_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_BASE_INTERNAL_ENDIAN_H_

#include "absl/base/internal/endian.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_BASE_INTERNAL_ENDIAN_H_
