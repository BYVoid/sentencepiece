...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_NUMERIC_BITS_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_NUMERIC_BITS_H_

#include "absl/numeric/bits.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_NUMERIC_BITS_H_
