...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_TIME_CLOCK_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_TIME_CLOCK_H_

#include "absl/time/clock.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_TIME_CLOCK_H_
