...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_STATUS_STATUS_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_STATUS_STATUS_H_

#include "absl/status/status.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_STATUS_STATUS_H_
