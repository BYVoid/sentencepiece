...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_STATUS_STATUS_MACROS_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_STATUS_STATUS_MACROS_H_

#include "absl/status/status_macros.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_STATUS_STATUS_MACROS_H_
