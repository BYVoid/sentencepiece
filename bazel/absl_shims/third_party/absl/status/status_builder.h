...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_STATUS_STATUS_BUILDER_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_STATUS_STATUS_BUILDER_H_

#include "absl/status/status_builder.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_STATUS_STATUS_BUILDER_H_
