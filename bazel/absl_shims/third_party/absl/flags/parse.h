...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_FLAGS_PARSE_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_FLAGS_PARSE_H_

#include "absl/flags/parse.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_FLAGS_PARSE_H_
