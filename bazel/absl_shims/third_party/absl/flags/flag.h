...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_FLAGS_FLAG_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_FLAGS_FLAG_H_

#include "absl/flags/flag.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_FLAGS_FLAG_H_
