...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_SYNCHRONIZATION_MUTEX_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_SYNCHRONIZATION_MUTEX_H_

#include "absl/synchronization/mutex.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_SYNCHRONIZATION_MUTEX_H_
