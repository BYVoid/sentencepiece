...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_CONTAINER_FIXED_ARRAY_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_CONTAINER_FIXED_ARRAY_H_

#include "absl/container/fixed_array.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_CONTAINER_FIXED_ARRAY_H_
