...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_CONTAINER_BTREE_SET_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_CONTAINER_BTREE_SET_H_

#include "absl/container/btree_set.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_CONTAINER_BTREE_SET_H_
