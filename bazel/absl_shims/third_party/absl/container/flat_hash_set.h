...
#ifndef SENTENCEPIECE_BAZEL_ABSL_SHIMS_CONTAINER_FLAT_HASH_SET_H_
#define SENTENCEPIECE_BAZEL_ABSL_SHIMS_CONTAINER_FLAT_HASH_SET_H_

#include "absl/container/flat_hash_set.h"

#endif  // SENTENCEPIECE_BAZEL_ABSL_SHIMS_CONTAINER_FLAT_HASH_SET_H_
